...
// For local testing:
// const API_BASE_URL = 'https://staffassist-backend.onrender.com/api';

// For production (Render):
const API_BASE_URL = 'https://staffassist-backend.onrender.com/api'; // Replace with your actual Render URL later!
